...
# ------------------------------------------------------------------------------
'''NOTES
nohup python -u ~/HICCUP/get_nudging_data.ERA5.py \
    --start-date=20220727 \
    --final-date=20220910 \
    --start-hour=00 --final-hour=00 --data-freq=3h --batch-mode=day \
    --output-root=/lustre/orion/cli115/proj-shared/hannah6/TAOS/2026-STRONG-CA/files_init/nudging_raw \
    > ~/TAOS/projects/2026-STRONG-CA/logs_hiccup/log.hiccup.get_nudging_data.20260803 & 
...
beg_date = datetime.datetime.strptime('2022-07-27', '%Y-%m-%d')
end_date = datetime.datetime.strptime('2022-09-10', '%Y-%m-%d')
